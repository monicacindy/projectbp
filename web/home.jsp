<%-- 
    Document   : index
    Created on : Dec 2, 2020, 2:55:12 PM
    Author     : monica
--%>
...
<html>
 ...
 <center>
 <hr>
 <form action="prosesinputuser.jsp" method="post">
 <table width="500px" border="3" bgcolor="lightskyblue">
 <tr>
 ...
 <tr>
 <td></td><td><input type="submit" name="proses" value="Daftar" onclick="return confirm('Apakah Yakin Ingin Mendaftar?')">
